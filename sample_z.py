...
# Parameters
n_slice_z = 5                                           # setting sampled z; 2, 5
...
# wavfile.write('./data/results/rec0.wav',  24000, yr_mod[0,  :])
# wavfile.write('./data/results/rec1.wav',  24000, yr_mod[2,  :])
# wavfile.write('./data/results/rec2.wav',  24000, yr_mod[4,  :])
# wavfile.write('./data/results/rec3.wav',  24000, yr_mod[6,  :])
# wavfile.write('./data/results/rec4.wav',  24000, yr_mod[8,  :])
# wavfile.write('./data/results/rec5.wav',  24000, yr_mod[10, :])
# wavfile.write('./data/results/rec6.wav',  24000, yr_mod[12, :])
# wavfile.write('./data/results/rec7.wav',  24000, yr_mod[14, :])
# wavfile.write('./data/results/rec8.wav',  24000, yr_mod[16, :])
# wavfile.write('./data/results/rec9.wav',  24000, yr_mod[18, :])
# wavfile.write('./data/results/rec10.wav', 24000, yr_mod[20, :])
# wavfile.write('./data/results/rec11.wav', 24000, yr_mod[22, :])
# wavfile.write('./data/results/rec12.wav', 24000, yr_mod[24, :])
# wavfile.write('./data/results/rec13.wav', 24000, yr_mod[26, :])
# wavfile.write('./data/results/rec14.wav', 24000, yr_mod[28, :])
# wavfile.write('./data/results/rec15.wav', 24000, yr_mod[30, :])
# wavfile.write('./data/results/rec16.wav', 24000, yr_mod[32, :])
# wavfile.write('./data/results/rec17.wav', 24000, yr_mod[34, :])
# wavfile.write('./data/results/rec18.wav', 24000, yr_mod[36, :])
# wavfile.write('./data/results/rec19.wav', 24000, yr_mod[38, :])
# wavfile.write('./data/results/rec20.wav', 24000, yr_mod[40, :])
# wavfile.write('./data/results/rec21.wav', 24000, yr_mod[42, :])
# wavfile.write('./data/results/rec22.wav', 24000, yr_mod[44, :])
# wavfile.write('./data/results/rec23.wav', 24000, yr_mod[46, :])
# wavfile.write('./data/results/rec24.wav', 24000, yr_mod[48, :])
# wavfile.write('./data/results/rec25.wav', 24000, yr_mod[50, :])
# wavfile.write('./data/results/rec26.wav', 24000, yr_mod[52, :])
# wavfile.write('./data/results/rec27.wav', 24000, yr_mod[54, :])
# wavfile.write('./data/results/rec28.wav', 24000, yr_mod[56, :])
# wavfile.write('./data/results/rec29.wav', 24000, yr_mod[58, :])

# plt.figure()
# plt.imshow(z_sampled)
# plt.show()

time = yr_mod.shape[1]/24000
t_axis = np.linspace(0, time, yr_mod.shape[1]//20+1)

plt.figure()
plt.subplot(121)
plt.plot(t_axis, yr_mod[18, :], 'o-', label='audio: ow', linewidth=1)
plt.ylabel('Amplitude (a.u.)')
plt.xlabel('Time (second)')
plt.legend()

plt.subplot(122)
plt.plot(t_axis, yr_mod[34, :], 'o-', label='audio: how', linewidth=1)
plt.ylabel('Amplitude (a.u.)')
plt.xlabel('Time (second)')
plt.legend()
plt.show()
